...
public class SPDPersistence extends BaseDocumentPersistence {
    ...
    protected static final String ATTR_STATE_CODE = "s_state_code";
    ...
    protected static final String ATTR_IS_CHANGED = "b_is_changed";
    protected static final String ATTR_BANK_NAME = "s_bank_name";
    protected static final String ATTR_IS_URGENT = "b_is_urgent";
    protected static final String ATTR_IS_VIP = "b_is_vip";

    protected static final String ATTR_PD_INDEX_R = "n_pd_index_r";
    protected static final String ATTR_PD_DOC_NUMBER_R = "s_pd_doc_number_r";
    protected static final String ATTR_PD_DOC_DATE_R = "t_pd_doc_date_r";
    protected static final String ATTR_PD_DOC_KIND_CODE_R = "s_pd_doc_kind_code_r";
    protected static final String ATTR_PD_KVALP_R = "s_pd_kvalp_r";
    protected static final String ATTR_PD_SUMMAP_R = "d_pd_summap_r";
    protected static final String ATTR_PD_SUMMAP2_R = "d_pd_summap2_r";
    protected static final String ATTR_PD_KVALK_R = "s_pd_kvalk_r";
    protected static final String ATTR_PD_SUMMAK_R = "d_pd_summak_r";
    protected static final String ATTR_PD_SUMMAK2_R = "d_pd_summak2_r";
    protected static final String ATTR_PD_PRIZ_POST_R = "b_pd_priz_post_r";
    protected static final String ATTR_PD_SROK_WAIT_R = "t_pd_srok_wait_r";
    protected static final String ATTR_PD_KSTRANA_R = "s_pd_kstrana_r";
    protected static final String ATTR_PD_PRIMESH_R = "s_pd_primesh_r";
    protected static final String ATTR_PD_DOC_TYPE_R = "s_pd_doc_type_r";
    protected static final String ATTR_PD_CHANNEL_NAME_R = "s_pd_channel_name_r";
    protected static final String ATTR_PD_CHANNEL_REF_ID_R = "s_pd_channel_ref_id_r";
