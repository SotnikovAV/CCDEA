 ...
 *
 */
public class TestDocPutReceiverMethod {
	
	@Test
	public void test() {
		String[] filePathes = { 
//				"C:/Development/Workspaces/CCDEA_GITHUB/test/DocPut/DocScan/pdf.xml",
//				"C:/Development/Workspaces/CCDEA_GITHUB/test/DocPut/DocReference/zip.xml",
				"C:/Development/Workspaces/CCDEA_GITHUB/test/7z.xml",
		};
        ...
        try {
			...
			for (String filePath : filePathes) {
				BaseReceiverMethod receiverMethod = new DocPutReceiverMethod();
				...
				MessageObjectProcessor messageObjectProcessor = receiverMethod
						.getMessageObjectProcessor(messageXmlContent);
