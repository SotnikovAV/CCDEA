...
<dmf:form>
    <dmf:datagrid rowselection="true" name="contragent_datagrid" paged="false" preservesort="true"
        ...
        <tr class="colHeaderBackground">
            <dmf:celllist fields="s_contr_name_r,s_contr_country_code_r,s_contr_bank_country_code_r" nlsids="MSG_CONTRAGENT_NAME,MSG_CONTRAGENT_COUNTRY_CODE,MSG_CONTRAGENT_BANK_COUNTRY_CODE">
                <dmf:celltemplate field="s_contr_name_r">
                ...
                <dmf:celltemplate field="s_contr_country_code_r">
                ...
                <dmf:celltemplate field="s_contr_bank_country_code_r">
                    <dmf:datagridTh scope='col' cssclass='doclistfilenamedatagrid leftAlignment' >
                        <dmf:datasortlink name='contragent_country_sortlink' datafield='CURRENT' cssclass='doclistbodyDatasortlink' />
                    </dmf:datagridTh>
                </dmf:celltemplate>
        ...
        <dmf:datagridRow cssclass="defaultDatagridRowAltStyle">
            <dmf:celllist fields="s_contr_name_r,s_contr_country_code_r,s_contr_bank_country_code_r">
                <dmf:celltemplate field="s_contr_name_r">
