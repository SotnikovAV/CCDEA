...
public class PassportContragentComponent extends Component {
    ...
    public void onInit(ArgumentList arg) {
        ...
        dataProvider.setQuery("select s_contractor_name_r, s_contractor_country_code_r from ccdea_passport where r_object_id = " + DfUtil.toQuotedString(objectId) + " and s_contractor_name_r is not null enable(row_based)");
    }
}
