...
create or replace force view "CCDEA_RPT_DOSSIERS"
(
    r_object_id,
    s_state,
    t_creation_date,
...
select
    r_object_id,
    s_state,
    CASE WHEN t_creation_date = TO_DATE('0001-01-01','yyyy-MM-dd') THEN
      null 
    ELSE 
      t_creation_date 
    END as t_creation_date,
    CASE WHEN t_archive_date = TO_DATE('0001-01-01','yyyy-MM-dd') THEN
      null 
    ELSE 
      t_archive_date 
    END as t_archive_date,
    s_archive_number
from
	ccdea_dossier_sp
;

create or replace force view "CCDEA_RPT_VBK_CONTRACTORS"
(
    r_object_id,
    s_contractor_name_r,
    s_contractor_country_code_r
)
as
...
from
	ccdea_vbk_rp
where
    s_contractor_name_r is not null
;

create or replace force view "CCDEA_RPT_PS_CONTRACTORS"
(
    r_object_id,
    s_contractor_name_r,
    s_contractor_country_code_r
...
create or replace force view "CCDEA_RPT_SPD_DETAILS"
(
    r_object_id,
    n_pd_index_r,
    s_pd_doc_number_r,
	t_pd_doc_date_r,
	s_pd_doc_kind_code_r,
	s_pd_kvalp_r,
	d_pd_summap_r,
	d_pd_summap2_r,
	s_pd_kvalk_r,
...
select
    ...
    n_pd_index_r,
    s_pd_doc_number_r,
	CASE WHEN t_pd_doc_date_r = TO_DATE('0001-01-01','yyyy-MM-dd') THEN
      null 
    ELSE 
      t_pd_doc_date_r 
    END as t_pd_doc_date_r,
	s_pd_doc_kind_code_r,
	s_pd_kvalp_r,
	d_pd_summap_r,
	d_pd_summap2_r,
	...
	d_pd_summak2_r,
	b_pd_priz_post_r,
	CASE WHEN t_pd_srok_wait_r = TO_DATE('0001-01-01','yyyy-MM-dd') THEN
      null 
    ELSE 
      t_pd_srok_wait_r 
    END as t_pd_srok_wait_r,
	s_pd_kstrana_r,
	s_pd_primesh_r,
	s_pd_doc_type_r,
	s_pd_channel_name_r,
...
from
	ccdea_spd_rp
where
	n_pd_index_r is not null
;

create or replace force view "CCDEA_RPT_CONTRACT_SUMS"
(
    r_object_id,
    n_sums_order_num_r,
    d_sums_amount_r,
	s_sums_currency_code_r
)
as
...
from
	ccdea_contract_rp
where
    n_sums_order_num_r is not null
;

create or replace force view "CCDEA_RPT_CONTRACT_CONTR"
(
    r_object_id,
    n_contr_order_num_r,
    s_contr_name_r,
	s_contr_country_code_r,
	s_contr_bank_country_code_r
)
as
...
from
	ccdea_contract_rp
where
    n_contr_order_num_r is not null
;

create or replace force view "CCDEA_RPT_CONTRACT_402"
(
    r_object_id,
    s_402_service_code_r,
    s_402_service_name_r
)
as
...
from
	ccdea_contract_rp
where
    s_402_service_code_r is not null
;

create or replace force view "CCDEA_RPT_CONTRACT_TYPES"
(
    r_object_id,
    s_contract_type_code_r
)
as
...
from
	ccdea_contract_rp
where
    s_contract_type_code_r is not null
;
