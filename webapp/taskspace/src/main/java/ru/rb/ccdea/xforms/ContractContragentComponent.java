...
public class ContractContragentComponent extends Component {
    ...
    public void onInit(ArgumentList arg) {
        ...
        dataProvider.setQuery("select s_contr_name_r, s_contr_country_code_r, s_contr_bank_country_code_r from ccdea_contract where r_object_id = '" + objectId + "' and s_contr_name_r is not null enable(row_based)");
    }
}
