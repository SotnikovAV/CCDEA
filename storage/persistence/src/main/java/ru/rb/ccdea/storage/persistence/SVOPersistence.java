...
public class SVOPersistence extends BaseDocumentPersistence {
    ...
    protected static final String ATTR_BANK_COUNTRY_CODE = "s_bank_country_code";
    protected static final String ATTR_ACCOUNT = "s_account";
    protected static final String ATTR_IS_URGENT = "b_is_urgent";
    protected static final String ATTR_IS_VIP = "b_is_vip";
    protected static final String ATTR_DETAIL_INDEX = "n_detail_index";
    protected static final String ATTR_DETAIL_DATE = "t_detail_date";
    protected static final String ATTR_VO_CODE = "s_vo_code";
    protected static final String ATTR_PAYMENT_NUMBER = "s_payment_number";
    protected static final String ATTR_PAYMENT_DATE = "t_payment_date";
    protected static final String ATTR_PAYMENT_AMOUNT = "d_payment_amount";
    protected static final String ATTR_PAYMENT_CURRENCY_CODE = "s_payment_currency_code";
    protected static final String ATTR_PAYMENT_FLAG = "n_payment_flag";
    protected static final String ATTR_VALID_DATE = "t_valid_date";
    protected static final String ATTR_REMARKS = "s_remarks";
