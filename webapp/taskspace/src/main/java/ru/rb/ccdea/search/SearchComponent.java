...
public class SearchComponent extends Container {
    ...
    private static final String printDql= 
    		" select r_object_id, object_name, r_content_size from dm_sysobject where "
    		+ " r_object_id in ("
		    ...
		    + " from dm_sysobject#1 cont, dm_relation rel, ccdea_content_part#1 part "
		    + " where  rel.relation_name='ccdea_content_relation' "
		    + " and cont.r_object_id = rel.child_id "
		    + " and rel.parent_id in ('#2') "
		    ...
		    + " ) OR r_object_id in ( "
		    + " select part.r_object_id "
		    + " from dm_sysobject#1 cont, dm_relation rel, ccdea_doc_content_part#1 part "
		    + " where  rel.relation_name='ccdea_content_relation' "
		    + " and cont.r_object_id = rel.child_id "
		    + " and rel.parent_id in ('#2') "
		    + " and cont.a_content_type in (#3) "
    ...
    private static final String printDossierDql =
    		" select r_object_id, object_name, r_content_size from dm_sysobject "
            ...
            + " ) OR r_object_id in ( "
            + " select part.r_object_id " 
    		+ " from dm_sysobject#1 cont, dm_relation rel, ccdea_base_doc doc1, ccdea_base_doc doc2, ccdea_content_part#1 part  "
            + " where rel.relation_name='ccdea_content_relation' "
            + " and cont.r_object_id = rel.child_id "
            + " and rel.parent_id = doc1.r_object_id "
            + " and doc1.id_dossier = doc2.id_dossier "
            ...
            + " ) OR r_object_id in ( "
            + " select part.r_object_id " 
    		+ " from dm_sysobject#1 cont, dm_relation rel, ccdea_base_doc doc1, ccdea_base_doc doc2, ccdea_doc_content_part#1 part  "
            + " where rel.relation_name='ccdea_content_relation' "
            + " and cont.r_object_id = rel.child_id "
            + " and rel.parent_id = doc1.r_object_id "
            + " and doc1.id_dossier = doc2.id_dossier "
