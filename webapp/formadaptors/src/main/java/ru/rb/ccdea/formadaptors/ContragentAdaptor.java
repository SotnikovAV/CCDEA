 ...
 */
public class ContragentAdaptor extends ContractAdaptor {
    ...
    private enum OutputParams{
        s_contr_name_r, s_contr_country_code_r, s_contr_bank_country_code_r
    }
    @Override
    public Document execute(IAdaptorParameter[] iAdaptorParameters) throws AdaptorException {
        String value=getParameter(iAdaptorParameters,InputParams.r_object_id.toString());
        ...
        try{
            ...
            IDfQuery query = new DfQuery(getDql(value));
