...
public class ContractPersistence extends BaseDocumentPersistence{
    ...
    protected static final String ATTR_IS_URGENT = "b_is_urgent";
    protected static final String ATTR_IS_VIP = "b_is_vip";
    protected static final String ATTR_IS_AML = "b_is_aml";
    protected static final String ATTR_IS_PAYMENT_ADVANCE = "b_is_payment_advance";
    protected static final String ATTR_IS_PAYMENT_DELAY = "b_is_payment_delay";
    protected static final String ATTR_IS_CLOSED = "b_is_closed";
    protected static final String ATTR_EXPIRE_DATE = "t_expire_date";
    protected static final String ATTR_CLOSE_DATE = "t_close_date";
    protected static final String ATTR_ARCHIVE_DOSSIER_NUMBER = "s_archive_dossier_number";
    protected static final String ATTR_IS_THIRD_PARTY = "b_is_third_party";
    protected static final String ATTR_REPORT402 = "b_report402";
    protected static final String ATTR_REPORT405 = "b_report405";
    protected static final String ATTR_REPORT406 = "b_report406";
    protected static final String ATTR_NO_GENERAL_AMOUNT = "b_no_general_amount";
    protected static final String ATTR_GENERAL_AMOUNT = "d_general_amount";
    protected static final String ATTR_GENERAL_PAYMENT_AMOUNT = "d_general_payment_amount";
    protected static final String ATTR_GENERAL_CURRENCY_CODE = "s_general_currency_code";
    protected static final String ATTR_IS_REORGANIZATION = "b_is_reorganization";
    protected static final String ATTR_REORGANIZATION_INFO = "s_reorganization_info";
    protected static final String ATTR_CUSTOMER_CAPITAL = "d_customer_capital";
    protected static final String ATTR_CUSTOMER_REG_DATE = "t_customer_reg_date";
    protected static final String ATTR_SHIPPING_COUNTRY_CODE = "s_shipping_country_code";
    protected static final String ATTR_SHIPPER_COUNTRY_CODE = "s_shipper_country_code";
    protected static final String ATTR_PORT_COUNTRY_CODE = "s_port_country_code";
    protected static final String ATTR_SHIP_NAME = "s_ship_name";
    protected static final String ATTR_THIRD_COUNTRY_CODE = "s_third_country_code";
    protected static final String ATTR_THIRD_BANK_COUNTRY_CODE = "s_third_bank_country_code";
    protected static final String ATTR_COMMENT = "s_comment";

    protected static final String ATTR_SIGNING_DATE = "t_signing_date";

    protected static final String ATTR_SUMS_ORDER_NUM_R = "n_sums_order_num_r";
    protected static final String ATTR_SUMS_AMOUNT_R = "d_sums_amount_r";
    protected static final String ATTR_SUMS_CURRENCY_CODE_R = "s_sums_currency_code_r";
    protected static final String ATTR_CONTR_ORDER_NUM_R = "n_contr_order_num_r";
    protected static final String ATTR_CONTR_NAME_R = "s_contr_name_r";
    protected static final String ATTR_CONTR_COUNTRY_CODE_R = "s_contr_country_code_r";
    protected static final String ATTR_CONTR_BANK_COUNTRY_CODE_R = "s_contr_bank_country_code_r";
    protected static final String ATTR_402_SERVICE_CODE_R = "s_402_service_code_r";
    protected static final String ATTR_402_SERVICE_NAME_R = "s_402_service_name_r";
    protected static final String ATTR_CONTRACT_TYPE_CODE_R = "s_contract_type_code_r";
